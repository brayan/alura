...
public class LeilaoTest {
    ...
    public void deve_DevolverTresMaioresLances_QuandoRecebeExatosTresLances(){
        ...
        assertThat(tresMaioresLancesDevolvidos, both(Matchers.<Lance>hasSize(3)).and(contains(new Lance(ALEX, 400.0),
                new Lance(new Usuario("Fran"), 300.0),
                new Lance(ALEX, 200.0))));
    }
    ...
    public void naoDeve_AdicionarLance_QuandoForMenorQueOMaiorLance() {
        ...
        int quantidadeLances = CONSOLE.getQuantidadeLances();

        assertEquals(1, quantidadeLances);
    }

    @Test(expected = LanceSeguidoDoMesmoUsuarioException.class)
    public void naoDevo_AdicionarLance_QuandoForOMesmoUsuarioDoUltimoLance() {
        CONSOLE.propoe(new Lance(ALEX, 500.0));
        CONSOLE.propoe(new Lance(ALEX, 600.0));
    }

    @Test(expected = UsuarioJaDeuCincoLancesException.class)
    public void naoDevo_AdicionarLance_QuandoUsuarioDer5Lances() {
        final Usuario FRAN = new Usuario("Fran");
